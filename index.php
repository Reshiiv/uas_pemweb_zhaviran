...
<head>
    ...
    <title>Zhaviran Bookstore</title>
...
<body>
    ...
    <section id="New">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="m-8 font-extrabold text-4xl text-center border-t-2 " style="color: rgb(0, 0, 0);">
                Best Book
            </h2>
        </div>
    </section>
        ...
        <div class="box-container">
            ...
            ?>
                    ...
                    <div class="box" style="width: 255px; height:355px;">
                        ...
                        <div class="price">Price: Rp <?php echo $fetch_book['price']; ?>,000</div>
    ...
    <section id="Adventure">
        ...
        <div class="container px-5 mx-auto">
            <h2 class="text-gray-400 m-8 font-extrabold text-4xl text-center border-t-2 text-red-800" style="color: rgb(0, 0, 0);" >
                Adventure
            </h2>
        </div>
    </section>
