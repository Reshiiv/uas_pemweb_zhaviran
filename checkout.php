        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="email" name="number" placeholder="000 00000 0000">
              ...
              <input type="text" id="city" name="state" placeholder="Your State">

              <div style="padding: 0px;" class="row">
                <div class="col-50">
                  <label for="state">Country</label>
                  <input type="text" id="state" name="country" placeholder="...">
                </div>
                <div class="col-50">
                  <label for="zip">Pincode</label>
                  <input type="text" id="zip" name="pincode" placeholder="...">
                </div>
              </div>
            </div>
            ...
            <div class="col-50">
              <div class="col-25">
                <div class="container">
                  ...
                  ?>
                      <p> <a href="book_details.php?details=<?php echo $fetch_cart['book_id']; ?>"><?php echo $fetch_cart['name']; ?></a><span class="price">(<?php echo 'Rp ' . $fetch_cart['price'] . ',000' . ' x ' . $fetch_cart['quantity']; ?>)</span> </p>
                  <?php
                    }
                  } else {
                  ...
                  <hr>
                  <p>Grand total : <span class="price" style="color:black">Rp <b><?php echo $grand_total; ?>,000</b></span></p>
                </div>
              </div>
