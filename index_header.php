...
<body>
  <header>
    <div class="logo">
        <a href="index.php"><span>Zhaviran Book</span>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">Best Book</a>
    ...
    <a class="Btn" href="search_books.php"><img style="height:30px;" src="./images/search3.png" alt=""></a>
    <?php if(isset($_SESSION['user_name'])){echo' <img style="height:40px; margin-left:10px ;" src="images/ds2.png" class="user-pic" onclick="toggleMenu()" />';}
        ...
        echo'<div class="use_links"><a class="link_Btn" style="background-color: rgb(0, 76, 148);
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
        font-weight: 500;" href="login.php">Login</a><a class="link_Btn" style="background-color: rgb(0, 76, 148);
        padding: 6px;
        border-radius: 10px;
        margin-left: 10px;
        color: white;
...
<div class="sub-menu-wrap" id="subMenu">
  <div class="sub-menu">
    ...
    <a href="logout.php" class="sub-menu-link">
      <p style="background-color: #004C94 ; border-radius:8px; text-align:center; color:white; font-weight:600; margin-top:5px; padding:5px;">Logout</p>
    </a>
  </div>
</div>
